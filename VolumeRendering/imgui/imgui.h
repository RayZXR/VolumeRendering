...
// Enumerations
// - We don't use strongly typed enums much because they add constraints (can't extend in private code, can't store typed in bit fields, extra casting on d_iteration)
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_CallbackAlways      = 1 << 8,   // Callback on each d_iteration. User code may query cursor position, modify text buffer.
...
// - ImGuiInputTextFlags_CallbackAlways:      Callback on each d_iteration
